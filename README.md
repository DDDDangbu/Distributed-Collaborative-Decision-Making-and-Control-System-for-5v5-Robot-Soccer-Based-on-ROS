...
本项目是我参加**中国机器人大赛中型组仿真赛**开发的完整机器人足球控制策略系统。在赛方提供的ROS+Gazebo仿真平台基础上，我独立实现了包含**策略决策、角色分配、行为规划、运动控制**在内的完整控制系统，共计**18个核心模块、超过3000行代码**。
...
- **比赛名称**：中国机器人大赛中型组仿真比赛（China Robot Competition - Middle Size Simulation League）
- **比赛形式**：5v5机器人足球对抗赛
